...
- There are a few dashboards that utilize the [dendrogram](https://github.com/hobbes3/splunk_dendrogram) Splunk app. The dashboards will function without this piece, however, some useful visualizations can be added by using this app. Instructions are provided below.
...
- If you want to add some visualizations to Tango, you will need to install the dendrogram splunk app, which can be found [here](https://github.com/hobbes3/splunk_dendrogram). In order for the visualization to work, follow the steps below:
```
$ git clone https://github.com/hobbes3/splunk_dendrogram.git
$ cp -r splunk_dendrogram/appserver/static/ /opt/splunk/etc/apps/tango/appserver/static
```
